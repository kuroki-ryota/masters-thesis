...
\usepackage{authblk,xurl,xcolor}
...
\title{A constructive proof of the general Nullstellensatz for Jacobson rings}
\author{Ryota Kuroki}
...
Secondly, I would like to thank my secondary supervisor, Takeshi Saito, for giving me advice during meetings and seminars.
...
I would like to thank Claude Quitté, Henri Lombardi, Stefan Neuwirth, and Ryotaro Iwane for their valuable comments on the contents of this thesis.
I would also like to thank Yuto Ikeda for reading the draft of my thesis and for providing helpful advice.
I would like to thank Daniel Misselbeck-Wessel for pointing out that my result is relevant to some problems in Lombardi's list.
...
The most important step in our constructive proof of the general Nullstellensatz is the generalization (\cref{Emerton}) of Lemma 6 in Emerton's notes \cite{Eme}.
The lemma is about integral domains, and we need some non-constructive principle to obtain the general Nullstellensatz from it.
...
Obtaining constructive generalization of \cite[Lemma 6]{Eme} is the most crucial process in the proof of our main theorem.
...
We have developed the basic constructive theory of Jacobson ring and obtained a constructive proof of the general Nullstellensatz.
...
\begin{definition}
    We call a ring $A$ \emph{finitely Jacobson} if every finitely generated ideal $I$ of $A$ satisfies $\Jac I\subseteq\Nil I$.
\end{definition}
\noindent
...
\bibitem[Lor25]{Lor25} Lorenzen, P. (2025). Algebraic and logistic investigations on free lattices. (Neuwirth, S., trans.) \emph{History and Philosophy of Logic}. 1--25. DOI: \href{https://doi.org/10.1080/01445340.2024.2444825}{10.1080/01445340.2024.2444825}.
