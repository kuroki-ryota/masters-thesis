...
Lastly, I would like to thank my parents for supporting my life and enabling me to focus on my research.
...
\newpage
This thesis contains the contents of the following paper, which has been accepted for publication:
\begin{itemize}
    \item Kuroki, R. (2025). A constructive proof of the general Nullstellensatz for Jacobson rings. \emph{Comm. Algebra}. 1--11. DOI: \href{https://doi.org/10.1080/00927872.2025.2554952}{10.1080/00927872.2025.2554952}
\end{itemize}
...
\end{proof}
\begin{remark}
    The statement of Emerton's lemma \cite[Lemma 6]{Eme} is as follows:
    \begin{quote}
            ...
            \item Let $\p$ be a prime ideal of $B'$.
                  ...
                  \begin{itemize}
                    ...
                    \item If $a\notin\p$, then $a\in A''-\{0\}$.
                          Hence $\Jac_{B''}0=0$ by Emerton's lemma.
