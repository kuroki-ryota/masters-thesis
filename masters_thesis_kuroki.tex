...
In this thesis, based on this proposal by Wessel and the idea of the classical proof by Emerton \cite[Theorem 8]{Eme}, we give a constructive proof of the general Nullstellensatz (\cref{general-nullstellensatz}).
